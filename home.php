	    ...
	    <div class="container">
	      ...
	      <section class="content">
			...
			// Fetch all positions
				...
				// Flag to track if all positions have publish_result set to 1
				$allPositionsPublished = true;
				...
				// Check if publish_result is not 1
				if ($publishResult != 1) {
					
					// If any position has publish_result other than 1, set the flag to false and break the loop
					$allPositionsPublished = false;
			...
			//end check
				...
				// Fetch election name from the positions table
				...
				if ($result->num_rows > 0) {
					...
					// If no election name is found, set a default value
					$title = "Default Election Name";
				}
	        	...
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
                            ...
                            // Check if all positions have publish_result set to 1
                            if ($allPositionsPublished) {
                                // Include files to display results
